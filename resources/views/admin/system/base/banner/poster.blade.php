        ...
        <div class="admin_info clearfix">
            ...
            <div class="mainbox">
                <form name="profile-form" class="base_form layui-form" method="post" class="mtb20" >
                    ...
                    <li @if(isset($model['image']) && count($model['image']) >= 1) hidden @endif class="image-upload-add" data-num="1" data-box="image_box" data-item='<span class="self-add-img"><img src=""><input type="hidden" name="data[image][]" value=""><span hidden="" class="img-delete"><i class="icon-shanchu iconfont"></i></span></span>'>
                    <a class="tra_photofile">上传图片</a>
                    </li>
                    </ul>
                    <p class="fgray">分享海报图片 为一张</p>
                    </div>
                    </div>
                    </div>
