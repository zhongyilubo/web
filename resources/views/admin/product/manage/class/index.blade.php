    ...
    <div class="content_ch">
        ...
        <div class="admin_info clearfix">
            ...
            <ul class="nav_pills mb10 clearfix">
                <a href="{{ url('product/manage/class') }}"><li class="selected">专栏管理</li></a>
                <a class="btn btn_r" href="{{ url('product/manage/class/create') }}">+ 创建专栏</a>
            </ul>
            <div class="mainbox">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @forelse($lists as $lv)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{!! url('product/manage/class/create',['category'=>$lv['id']]) !!}">编辑</a>
                                    </td>
                                </tr>
                            @empty
