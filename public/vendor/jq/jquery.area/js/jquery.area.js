...
function clockArea() {
	...
	// 	性别
	$("#expressArea-sex").click(function() {
		$("#areaMask").fadeIn();
		$("#areaLayer-sex").animate({"bottom": 0}).attr("flag","0");
	});
	$("#areaMask").click(function() {
		clockArea();
		$("#areaLayer-sex").animate({"bottom": '-100%'}).attr("flag","1");
		$("#expressArea-sex").val();
	});
	$("aside p").click(function(){
		clockArea();
		$("#expressArea-sex").val($(this).text());
		$("#areaLayer-sex").animate({"bottom": '-100%'}).attr("flag","1");
	})
	$("#user-data-edit").click(function(){
		$("#areaMask").fadeIn();
	})
